...
public class TST<Value> {
     ...
     */
    public Iterable<StringBuilder> keysWithPrefix(String prefix) {
     ...
     */
    public Iterable<StringBuilder> keysThatMatch(String pattern) {
        Queue<StringBuilder> queue = new Queue<StringBuilder>();
        collect(root, new StringBuilder(), 0, pattern, queue);
        return queue;
    }
 
    private void collect(Node<Value> x, StringBuilder prefix, int i, String pattern, Queue<StringBuilder> queue) {
        if (x == null) return;
    ...
    public static void main(String[] args) {
        ...
        for (StringBuilder s : st.keysWithPrefix("shor"))
            StdOut.println(s);
        StdOut.println();

        StdOut.println("keysThatMatch(\".he.l.\"):");
        for (StringBuilder s : st.keysThatMatch(".he.l."))
            StdOut.println(s);
    }
}
